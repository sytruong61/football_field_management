...
public class DVReportYear extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Báo Cáo Doanh Thu Dịch Vụ Theo Năm");
        setToolTipText("");
        ...
        jLabel1.setText("BÁO CÁO DOANH THU DỊCH VỤ THEO NĂM");
    ...
    private void reportButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_reportButtonMouseClicked
        ...
        JFreeChart chart = ChartFactory.createBarChart(
                "Biểu đồ doanh thu dịch vụ theo năm", // Tiêu đề biểu đồ
                "Dịch Vụ", // Nhãn trục x
        ...
        ChartFrame frame = new ChartFrame("Biểu đồ doanh thu dịch vụ theo năm", chart);
        frame.pack();
